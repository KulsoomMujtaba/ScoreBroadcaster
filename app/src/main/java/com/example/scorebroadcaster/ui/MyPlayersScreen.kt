...
fun MyPlayersScreen(
    ...
    Column(
        ...
        if (myPlayers.isEmpty()) {
            ...
            Text(
                text = "No players in My Players yet. Add one to reuse them when setting up teams.",
...
// =============================================================================
// Create My Player dialog
// =============================================================================

@Composable
fun CreateMyPlayerDialog(
    onDismiss: () -> Unit,
    ...
    AlertDialog(
        ...
        text = {
            Column(verticalArrangement = Arrangement.spacedBy(10.dp)) {
                ...
                Text(
                    text = "This player will be saved to My Players and can be reused when creating teams or adding players to matches.",
                    style = MaterialTheme.typography.bodySmall,
                    color = MaterialTheme.colorScheme.onSurface.copy(alpha = 0.6f)
                )
            }
